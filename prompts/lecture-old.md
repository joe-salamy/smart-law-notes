...
Core Task:
Your task is to analyze the provided lecture transcript and generate **detailed, highly structured, and exam-focused study notes**.
...
6. Pay special attention to any comments that the professor makes regarding exam content or format.
7. Include a separate, distinct section at the very end titled **"Black Letter Law Summary"** that lists only the core, definitive legal rules covered.
