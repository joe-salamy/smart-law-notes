...
Core Task:
Generate **VERY CONCISE** law school notes from the provided text. **Adhere strictly to the source material** without using external knowledge. The notes must maintain a proportional structure, with the length of each section reflecting its emphasis in the original text.
